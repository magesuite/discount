...
class DiscountHelperTest extends \PHPUnit\Framework\TestCase
{
     ...
     */
    public function testItReturnsCorrectPercentage(int|string|null $specialPrice, ?string $specialPriceFrom, ?string $specialPriceTo, int $getPrice, ?int $customFinalPrice, int|false $expected): void // phpcs:ignore
    {
