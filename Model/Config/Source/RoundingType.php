...
class RoundingType implements \Magento\Framework\Data\OptionSourceInterface
{
    ...
    public function toOptionArray(): array
    {
        return [
            ...
            ['value' => PHP_ROUND_HALF_EVEN, 'label' => __('Rounds num towards the nearest even value when it is half way there, making both 1.5 and 2.5 into 2.')],
            ['value' => PHP_ROUND_HALF_ODD, 'label' => __('Rounds num towards the nearest odd value when it is half way there, making 1.5 into 1 and 2.5 into 3.')],
        ];
    }
}
